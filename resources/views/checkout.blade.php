...
<html lang="pt-BR">
    <head>
        ...
        <title>{{ config('app.name', 'Checkout Ficticio') }}</title>
            ...
            <div class="w-full max-w-xl mx-auto">
                ...
                <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" id="payment-form" method="post">
                    ...
                    <div class="mb-4">
                        ...
                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-400 leading-tight focus:outline-none focus:shadow-outline" readonly id="amount" name="amount" type="text" value="{{ number_format($amount, 2,'.','') }}">
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-500 leading-tight focus:outline-none focus:shadow-outline" id="installment" name="installment">
                            @for($i = 1; $i <= 12; $i++)
                                <option value="{{ $i }}">R$ {{ number_format(($amount/$i), 2) }} em {{ $i }}x</option>
                            @endfor
                        </select>
                    </div>
                    <div class="mb-4">
